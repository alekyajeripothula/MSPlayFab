...
import { CATALOG_VERSION, DownloadProgress, IStringDictionary, ITitleNewsData, PROGRESS_STAGES } from "../shared/types";
import styled, { ButtonTiny, DialogWidthSmall, DivConfirm, DivField, SpinnerLeft } from "../styles";
